<footer class="bg-primary">
    <div class="container">
        <div class="row justify-content-center justify-content-lg-start py-3 py-lg-5 g-3">
            ...
            <div class="col-lg-3 d-flex flex-column justify-content-center align-items-center align-items-lg-start gap-2">
                <div>
                    <?php
                ...
                <div>
                    ...
                    if (have_rows('phone_list', 'option')):
                        while (have_rows('phone_list', 'option')) : the_row();
                            ...
                            ?>
                            <a href="<?= $phone_url; ?>"
                               class="text-white border-end border-danger border-1 border-opacity-50 pe-3">
                                <?= $phone; ?>
                            </a>
            ...
            <div class="col-lg-3 d-inline-flex gap-2 align-items-center align-items-lg-end justify-content-center justify-content-lg-end">
                            ...
                            <li class="d-flex align-items-center justify-content-center icon-white">
                                <a href="<?= $url; ?>"
                                   class="p-2 position-relative">
                                    <i class="<?= $value; ?> d-flex align-items-center justify-content-center fs-2 "></i>
