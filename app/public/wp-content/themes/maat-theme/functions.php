...
function theme_scripts() {
	...
	if ( !is_page_template( 'landing-1403.php' ) || !is_page_template( 'datamaat-landing.php') ) {
	...
	wp_enqueue_style( 'RaviVF', get_template_directory_uri() . '/public/fonts/Ravi/fontFace.css', array() );
	...
	wp_enqueue_script('custom-js', get_template_directory_uri() . '/public/js/custome-js.js', array(), null, true);
}
