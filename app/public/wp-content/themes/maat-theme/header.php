...
<body <?php body_class(); ?>>
<header class="w-100 lazy <?php echo is_page_template( 'datamaat-landing.php' ) || is_page_template( 'landing-1403.php' ) || is_page_template( 'landing.php' ) ? 'd-none' : ''; ?>"
        ...
        <nav class="container d-none d-lg-block">
            ...
            <div class="row navbar lazy-slow">
                <div class="col-lg-6 d-none d-lg-block justify-content-start " id="navbarNav">
					...
					wp_nav_menu( array(
						'theme_location' => 'headerMenuLocation',
						'menu_class'     => 'navbar-nav flex-row pe-0 gap-xxl-5 gap-4 w-100 justify-content-between desktop-menu',
						'container'      => false,
						'menu_id'        => 'navbarTogglerMenu',
						'item_class'     => 'nav-item',
...
<?php } ?>
<?php if ( ! is_page_template( 'datamaat-landing.php' ) && ! is_page_template( 'landing.php' ) && ! is_page_template( 'landing-1403.php' ) ) { ?>
    <div class="gap"></div>
<?php } ?>
